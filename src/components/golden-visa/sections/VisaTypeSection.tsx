...
export const VisaTypeSection: React.FC<VisaTypeSectionProps> = ({
  ...
  return (
    ...
    >
      <FormSection
        title="Golden Visa Details"
        description="Additional requirements and authority costs for your selected visa type"
        icon={FileText}
      ...
      >
        <div className="space-y-4" style={{ fontFamily: 'Inter, sans-serif' }}>
          ...
          {/* Primary Visa Requirements and Authority Costs */}
          {primaryVisaRequired && (
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              className="space-y-6"
            >
              {/* NOC and Salary Certificate Requirements for Skilled Employee */}
              {currentVisaType === 'skilled-employee' && data && onFieldChange && (
