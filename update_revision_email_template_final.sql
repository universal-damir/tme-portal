-- Update the Application Requires Revision email template to EXACTLY match Review Request formatting
-- This will use the same blue header color and exact styling as Review Request
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hello {{user_name}},</p>
            <p>Your document has been reviewed and requires revisions:</p>
